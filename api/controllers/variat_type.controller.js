...
export const getVariantTypeById = async (req, res) => {
    try {
...
export const createVariantType = async (req, res) => {
...
export const updateVariantType = async (req, res) => {
    const variantTypeID = req.params.id;
    const { name, type } = req.body;
    if (!name) {
        return res.status(400).json({ success: false, message: "Name is required." });
...
export const deleteVariantType = async (req, res) => {
    const variantTypeID = req.params.id;
    try {
